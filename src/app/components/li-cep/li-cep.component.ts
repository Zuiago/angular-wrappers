...
import {CepValueValidator} from '../directives/cep-validator';

@Component({
  selector: 'li-cep',
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: LiCepComponent,
    multi: true,
  }],
  templateUrl: './li-cep.component.html',
  styleUrls: ['./li-cep.component.css']
})
export class LiCepComponent extends ElementFullBase<string> {

  @ViewChild(NgModel) model: NgModel;

  public identifier = `li-cep-${identifier++}`;
...
@NgModule({
  ...
  exports: [LiCepComponent, CepDirective, CepValueValidator],
  declarations: [LiCepComponent, CepDirective, CepValueValidator]
})
export class LiCepModule { }
